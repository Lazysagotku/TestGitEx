...
namespace ToastNotifications
{
    public partial class Notification : Form
    {
        ...
        public Notification(string title, string body, int duration, FormAnimator.AnimationMethod animation, FormAnimator.AnimationDirection direction, Action doActionOnClick)
        {
            InitializeComponent();
            BackgroundImage = Image.FromFile($"{MainForm.ResourcesSubdir}NotificationBackgroundImage.png");
            Icon = new Icon($"{MainForm.ResourcesSubdir}0_16õ16.ico");
            DoAction = doActionOnClick;
