...
{
    internal sealed class Param4UnreadCommentsInUserTasks : IParamMainForm
    {
        ...
        public Param4UnreadCommentsInUserTasks()
        {
            ParamResult =
                new ParamResult
                {
                    ParameterName = "Количество непрочитанных комментариев в задачах пользователя (IS)     ",
                    DetailsParameterName = "Задачи пользователя с непрочитанными комментариями",
